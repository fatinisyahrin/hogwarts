...
<div id="grad1"></div>
  <br>
  <center><h2><u><b>Hi Participant !</b></u></h2></center>
  <center><h3>NEW INFO</h3></center><br>


   <div class="content">
    <center><img src="image/poster.png" alt="poster" style="width:50%"</center>
    <br><br>
    <h3><b>Innovation Design Competition</b></h3><br>
    <p>Attention students of Hogwarts School of Witchcraft and Wizardry!<br><br>
      From 1st to 31st August, the competition 
      will be open for registration, giving you an opportunity to demonstrate your intelligence 
      and creativity.
      This competition is the perfect platform for you to showcase your unique talents. 
      We are seeking out-of-the-box thinkers who can come up with groundbreaking ideas that will 
      leave everyone spellbound.
      Don't miss out on this extraordinary opportunity! Register now and let your creativity 
      soar high like a Firebolt broogstick. <br><br></p>
      <center><a href="passm.php">
      <input type="submit" name="submit" value="Register" class="roundsg">
    </a></center>    
      <br>
      <br>
  </div>

...
<head>
    ...
    <meta http-equiv="X-UA-Compayible" content="IE-edge">
      <title>Manage Assessment | Hogwarts</title>
</head>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="login.php" id="logout" style="font-family: 'Montserrat', Arial, sans-serif; font-size: 13px;">Logout</a>
    ...
    $sql = "SELECT * FROM assessment where user = '$participantid' ORDER BY id DESC";
    $res = mysqli_query($conn,  $sql);

    if (mysqli_num_rows($res) > 0) {
        while ($assessment = mysqli_fetch_assoc($res)) {  
    ?>
    <tr>
        <div>
        <td><p class="text"><b><?=$assessment['id']?></b></p></td>
        <td><p class="text"><b><?=$assessment['fullname']?></b></p></td>
        <td><p class="text"><b><?=$assessment['faculty']?></b></p></td>
        <td><a href="file/<?= $assessment['file'] ?>" download>Download</a></td>
        <td><div class="icons">
            <p class="text"><a href="pedit.php?id=<?= $assessment['id'] ?>" onclick="return confirm('Are you sure you want to edit this project?')">Edit </a></p>
            <p class="text"><a href="pdelete.php?id=<?= $assessment['id'] ?>" onclick="return confirm('Are you sure you want to delete this project?')">Delete</a></p>
        </td>
      </div>
    </tr>                          
    <?php } }else { ?>

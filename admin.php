...
<div id="grad1"></div>
  ...
  <center><h2><u><b>Hi Admin !</b></u></h2></center>
  <center><h3>NEW INFO</h3></center><br>

  <div class="content">
    <center><img src="image/posteradmin.png" alt="poster" style="width:50%"</center>
    <br><br>
    <h3><b>Innovation Design Competition</b></h3><br>
    <p>Attention admins of Hogwarts School of Witchcraft and Wizardry!<br><br>
    The registration for the competition will be open from August 1st to 31st, 
    giving participants an opportunity to showcase their intelligence and creativity. 
    Please remember to assign a file to a judge by clicking the button below. <br><br></p>
      <center><a href="aviewass.php">
      <input type="submit" name="submit" value="Assign" class="roundsg">
    </a></center>    
      <br>
      <br>
  </div>

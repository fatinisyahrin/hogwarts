...
<head>
  ...
  <title>Submission | Hogwarts</title>
</head>
<style>
   /* width */
::-webkit-scrollbar {
...
<div class="main">
    ...
    <center><h2>List of Submission</h2></center><br>
    <table style="width:100%">
      ...
      <?php
      $sql = "SELECT id, user, fullname, faculty, judge, marks, file FROM assessment";
      ...
      if (mysqli_num_rows($res) > 0) {
          while ($assessment = mysqli_fetch_assoc($res)) {
              ?>
              <tr>
                  <td><p><?=$assessment['id']?></p></td>
                  <td><p><?=$assessment['user']?></p></td>
                  <td><p><?=$assessment['fullname']?></p></td>
                  <td><p><?=$assessment['faculty']?></p></td>
                  <td><p><?=$assessment['file']?></p></td>
                  <td><a href="file/<?=$assessment['file']?>" download>Download</a></td>
                  <td><p><?=$assessment['judge']?></p></td>
                  <td><p><?=$assessment['marks']?></p></td>
                  <td><p><a href="assign.php?id=<?= $assessment['id'] ?>"><input type="submit" name="submit" value="Assign"></a></p></td>
              </tr>
              <?php 
    } 
} else { 
